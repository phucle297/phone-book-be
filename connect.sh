...
scp -i src/models/phone-book.pem  src/ca_bundle.crt ubuntu@ec2-3-1-167-159.ap-southeast-1.compute.amazonaws.com:~
scp -i src/models/phone-book.pem  src/certificate.crt ubuntu@ec2-3-1-167-159.ap-southeast-1.compute.amazonaws.com:~
scp -i src/models/phone-book.pem  src/private.key ubuntu@ec2-3-1-167-159.ap-southeast-1.compute.amazonaws.com:~
